      ...
      <section className="firstpage">
        ...
        <div className="wrapper">
          ...
          <div className="firstpage__desc">
            ...
            <p>
              한편 한국 최초의 웹사이트는 1994년 KAIST 소속 대학원생이 제작한 한국 관광 자료 제공 사이트(<a href="http://cair.kaist.ac.kr" target="_blank">cair.kaist.ac.kr</a>)로 알려져 있다. 김병학은 한국관광공사에서 출판한 “Welcome to Korea”라는 영문 관광안내책자의 내용을 스캔해 글과 이미지 전문을 웹사이트에 게재했다. 제작자의 소속을 제외하면 국가적 정책이나 기술산업과 무관한 개인의 비공식적 작업이었지만, 그럼에도 불구하고 최초의 웹사이트가 국가에서 외국인 대상으로 만든 관광 자료를 담고 있었다는 점은 흥미로운 우연이다. 한국 웹은 국가적 지원을 바탕으로 형성된 기술적/제도적 인프라와, 한국을 세상에 알리는 내용을 공유한 개인 제작자가 만나는 지점에서 시작한 것이다.
            </p>
            <p>
